	...
	virtual void *soap_in(struct soap*, const char*, const char*);
	         ns6__MotionDesc() : tool(NULL), frame(NULL), absRel((enum ns6__MoveType)0),
				 ...
				 distBlendNext(0.05), vel(1.0), acc(1.0), dec(1.0), transVel(99999), rotVel(99999), freq(1.0), soap(NULL) { }
                  ns6__MotionDesc(enum ns6__BlendType mBlendType, double mDistBlendPrev, double mDistBlendNext, double mVel, double mAcc, double mDec, double mTransVel, double mRotVel) : tool(NULL), frame(NULL), absRel((enum ns6__MoveType)0),
				 config(NULL), blendType(mBlendType), distBlendPrev(mDistBlendPrev),
	  distBlendNext(mDistBlendNext), vel(mVel), acc(mAcc), dec(mDec), transVel(mTransVel), rotVel(mRotVel), freq(1.0), soap(NULL) { }
