...
# Named Tuple reprenting the dof state of the client
...
class JointTracjectoryActionServer(object):
    def __init__(self):
        ...
        # This creates a proxy for the action server for barrett client
        ...
        # This subscriber gets the current joint states of the client
        self._joint_sub = rospy.Subscriber("/joint_states",
                                           sensor_msgs.msg.JointState,
                                           self.update_joint_state_cb)

        # This publisher sends commands to the client
        ...
        # This allows a client to set whether or not the client should ignore
        ...
        # for tactile contacts which have stopped client movement.
        ...
        # This is the last recorded joint state for the client
        self.current_joint_state = None

        # This is the last recorded dof state of the client. These values
        # are used to determine new velocity commands 
        # in the follow_joint_trajectory_cb
        self.current_dof = None
        # This is the last recorded tactile state of the client
        self.current_tactile_state = None

        # This is the feedback published as the client moves along a trajectory.
        ...
        # this ensure before we begin executing a trajectory that the client is actually in the
        ...
        # This in HZ is how often we send a command to the client from within
    ...
    def _follow_joint_trajectory_cb(self, goal):
        ...
        # Ensure that the client is in a velocity control mode
        ...
        for i, waypoint in enumerate(goal.trajectory.points):
            ...
            while waypoint.time_from_start >= rospy.Time.now() - start_time:
                ...
                # Everything is going smoothly, send velocity cmd to client
    ...
    def update_joint_state_cb(self, msg):
        # client message not arm message
